...
const OurTeam = () => {
  return (
    ...
    >
      ...
      <div className="absolute team-overlay top-0 left-0 h-full w-full z-30 grid place-items-center">
        <div className="flex flex-col justify-center items-center lg:-mt-44 scale-75 lg:scale-100">
          <p className='font-maven mb-3 w-full text-left ml-4 text-[#ffffff7d] z-20 text-lg uppercase'>Passion in Action</p>
          ...
          <p className='font-maven mt-5 w-full text-right mr-4 text-[#ffffff7d] z-20 text-lg uppercase'>Discover Our Dynamic Team</p>
        </div>
      </div>
    </Swiper>
  );
