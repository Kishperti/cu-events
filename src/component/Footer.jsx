...
const Footer = () => {
    ...
    <h1 className="w-full text-3xl text-[#E2012D]">
        <img src="src/assets/c_a_c__2_-removebg-preview.png" alt="" className='w-[25%] h-[10%px]'/>
    </h1>
    ...
    <ul className='font-maven text-xl'>
        <li className="py-2 text-sm flex items-center"> 
            <FaPhone className="mr-2 text-xl" />(406) 555-0120
        </li>
        <li className="py-2 text-sm flex items-center">
            <IoMail className="mr-2 text-xl" /> support@cac-cuchd.in
        </li>
        <li className="py-2 text-sm flex items-center">
            <IoLocation className="mr-2 text-xl" /> Chandigarh University, NH-5 <br /> Chandigarh-Ludhiana Highway
        </li>
    </ul>
</div>
