...
const About = () => {
  return (
    <div className="container h-screen mx-auto mt-5 p-12 bg-[#070612] text-white font-maven">
        <div className="mr-32">
        <h1 className="text-3xl font-bold mt-5 text-white"> <span className=" text-red-700">CHECKOUT</span> ABOUT US</h1>
        <h6 className="ml-2">WHO WE ARE!</h6>
        </div>
      
      <p className=" py-12 text-justify w-11/12">
      ...
      <h1 className="text-9xl font-bold text-center text-opacity-50 text-gray-500">CAC-EVENTS</h1>
    </div>
  );
};
