    ...
    return (
        <div className=" main relative min-h-screen w-full bg-[#091022] flex flex-col items-center justify-start pt-[120px] pb-[200px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 px-8 lg:px-40 w-full mt-24">
                <div className="postcard w-full p-3 h-44 bg-[#ffe8e8] transition-all hover:scale-105 cursor-pointer shadow-2xl rounded-md">
                    <div className="w-full h-full p-5 border-dashed border-4 border-[#A2171C]">
                        <img src="https://raw.githubusercontent.com/devfolioco/brand-assets/f523906e2faeabd9e9f12d4ba62f53aa5b45b385/Logo%20+%20Text%20-%20Colored/Devfolio%20-%20Normal.svg" className='w-full h-full' alt="" />
                    </div>
                </div>
                <div className="postcard w-full p-3 h-44 bg-[#ffe8e8] transition-all hover:scale-105 cursor-pointer shadow-2xl rounded-md">
                    <div className="w-full h-full p-5 border-dashed border-4 border-[#A2171C]">
