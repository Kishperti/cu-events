    ...
    <header className="bg-[#091022] text-white p-4 w-full">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <a href="https://drive.google.com/file/d/1HJYaFVWZCinxJSF3DI-cQnbwgagul3x8/view?usp=sharing">
          <button className="w-[145px] justify-center font-bold hidden lg:block bg-[#E2012D] text-[#FFE8E8] text-center cursor-pointer transition-all duration-300 ease-in-out px-4 py-2 rounded hover:bg-[#A45053] hover:text-[#FFE8E8] rounded-tr-full">
          GUIDELINES
          </button>
        </a>
