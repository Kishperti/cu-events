            ...
            >
                <SwiperSlide className=' w-full min-h-screen flex flex-col pl-[20px] lg:pl-[100px] lg:pr-[25px] swiper-slide1'>
                    <div className='w-full flex flex-col mt-6 lg:mt-20 justify-center items-start'>
                        <h1 className='text-[3rem]  lg:text-6xl sm:text-[1.5rem] md:text-[2rem]  font-bold text-[#E2012D] font-oswald'>EVENT 1</h1>
                        <h1 className='text-[3rem] lg:text-6xl font-bold text-[#ffffff] font-oswald sm:text-[1.5rem] md:text-[2rem] mt-2 w-full'>LOREM IPSUM</h1>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-11 lg:gap-24 w-full py-[50px] mt-20 px-[20px] lg:px-12 mb-[50px] bg-[#00000081]">
